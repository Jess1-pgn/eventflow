@php
    ...
    $eventCoverImage = $event->cover_image_path
        ? (str_starts_with($event->cover_image_path, 'http')
            ? $event->cover_image_path
            : asset('storage/' . $event->cover_image_path))
        : 'https://picsum.photos/seed/' . rawurlencode($event->seo_slug) . '/1400/700';
    $seoEventImage = $eventCoverImage;
    $seoEventJsonLd = [
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <article class="card overflow-hidden">
                ...
                <div class="p-6 md:p-8 space-y-6">
                    <div class="relative aspect-[16/8] overflow-hidden rounded-2xl bg-gray-100">
                        <img
                            src="{{ $eventCoverImage }}"
                            alt="{{ $event->title }}"
